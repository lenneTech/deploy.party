...
export async function getRedisUi(container: Container): Promise<string> {
  ...
  return `
    ...
    ${additionalLabels.join('\n')}
            ...
            - traefik.http.services.${container.id}-app.loadbalancer.server.port=7843
      `
}
