...
* add RegistryModule and SourceModule to InternalMigrationModule ([a258d7b](https://github.com/lenneTech/deploy.party/commit/a258d7b286fe80a5cb56c782daed24ae4419ba04))
...
* fix plausible service ([ab7a1d7](https://github.com/lenneTech/deploy.party/commit/ab7a1d7225b45132bf3d75bf445aae26ad9f2528))
...
* fix plausible service ([17744fb](https://github.com/lenneTech/deploy.party/commit/17744fbacfcee8fe40b76f541be2952ac8f1317d))

## [2.11.1](https://github.com/lenneTech/deploy.party/compare/v2.11.0...v2.11.1) (2025-11-28)


### Bug Fixes

* fix plausible service ([4a5c974](https://github.com/lenneTech/deploy.party/commit/4a5c974932f7a82dc3d4e2585196723e5ce93f0f))
...
* simplify loader composable and integrate with GitHub/GitLab ([461e19f](https://github.com/lenneTech/deploy.party/commit/461e19f12f97f93e8dc134199a4751abb1734968))
...
* refactor update script for traefik ([44920f9](https://github.com/lenneTech/deploy.party/commit/44920f9dacf62f2aa3d1fc1f3ba1fec593d2949d))
...
* improve container lookup and enhance PostgreSQL dump command with package manager detection ([1fcbe95](https://github.com/lenneTech/deploy.party/commit/1fcbe9508b27b64415ec02a412c3789c372ea5bc))
